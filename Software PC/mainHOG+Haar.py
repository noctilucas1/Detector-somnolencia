...
#CAPTURE_SOURCE = r"C:\Users\lucas\OneDrive\Escritorio\Yo\Universidad\Mi TFG\UTA dataset\10.mp4\10.mp4"
...
def main():
    ...
    Predictor = dlib.shape_predictor(r'C:\Users\lucas\OneDrive\Escritorio\Yo\Universidad\Mi TFG\My_version\shape_predictor_68_face_landmarks.dat')  
    ...
    Initialization = startrout(Detector, Predictor, CAPTURE_SOURCE)
    ...
    Scorer = AttScorer(capture_fps=fps_lim, ear_tresh=ear_thresh, mar_thresh=MAR_thresh, ear_time_tresh=3, gaze_tresh=0.4, perclos_tresh=0.2,
                       gaze_time_tresh=4, pitch_tresh=165, roll_tresh=20, yaw_tresh=30, pose_time_tresh=6, verbose=False, mar_time_tresh=3)

    # Inicializar la captura de imágenes    
    cap = cv2.VideoCapture(CAPTURE_SOURCE)

    if not cap.isOpened():  # Si no se pueden capturar imágenes, cerrar
    ...
    grabador = cv2.VideoWriter(r'C:\Users\lucas\OneDrive\Escritorio\Yo\Universidad\Mi TFG\Deteccion_datasets\YoHoy3.avi', codec, fps_lim, (ancho, alto))

    # Para escribir en un archivo los datos del vídeo
    f = open(r'C:\Users\lucas\OneDrive\Escritorio\Yo\Universidad\Mi TFG\Deteccion_datasets\YoHoy3.txt', 'w')
